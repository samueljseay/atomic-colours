...
export function pressed(colour: string): string;
export function disabled(colour: string): string;

export function half(colour: string): string;
export function quarter(colour: string): string;
